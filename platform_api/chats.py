# platform_api/chats.py — GET /platform/chats (Chat Log data for the dashboard).
#
# Parallel to platform_api/calls.py, minus the recording/export surface —
# chat_sessions carries no recording_key, and (see chat_log.py's module
# comment) the LangGraph checkpointer stays the transcript source of truth.
